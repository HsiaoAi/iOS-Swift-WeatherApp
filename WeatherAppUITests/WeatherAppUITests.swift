...
//  WeatherAppUITests
//
//  Created by HsiaoAi on 2018/6/9.
...
class WeatherAppUITests: XCTestCase {
    ...
    func testSwithTabBarItem() {
        
        let tabBarsQuery = XCUIApplication().tabBars
        
        let tabBarItemForecastButton = tabBarsQuery.buttons["TabBarItemForecast"]
        tabBarItemForecastButton.tap()
